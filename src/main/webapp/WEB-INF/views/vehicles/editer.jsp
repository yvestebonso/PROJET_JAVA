...
<%--                                     <label for="first_name" class="col-sm-2 control-label">${ idUser}</label> --%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="manufacturer" name="manufacturer" value="${marque}"required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seats" name="seats" value="${NumPlaces}"required>
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
